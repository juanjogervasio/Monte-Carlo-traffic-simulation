...
For further details, see the [Jupyter notebook file](https://github.com/juanjogervasio/Monte-Carlo-traffic-simulation/blob/master/Fundamental%20diagrams.ipynb).
